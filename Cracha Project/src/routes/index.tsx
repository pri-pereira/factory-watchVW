            ...
            <form onSubmit={handleLogin} className="space-y-5">
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <input id="login-registro" type="text" required value={loginReg} onChange={(e) => setLoginReg(e.target.value)} placeholder="Ex: 0263552" autoComplete="off" className="w-full rounded-xl border border-white/10 bg-white/5 py-3 pl-11 pr-4 text-white placeholder-slate-600 focus:outline-none focus:ring-2 focus:ring-amber-400/30 focus:border-amber-400/50 transition-all" />
                </div>
              </div>
              <div className="space-y-1.5">
          ...
          {aba === "cadastro" && (
            <form onSubmit={handleCadastro} className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="space-y-1.5">
                  <label className="text-[10px] font-bold uppercase tracking-widest text-slate-400">N de Registro</label>
                  <input id="cad-registro" type="text" required value={cadReg} onChange={(e) => setCadReg(e.target.value)} placeholder="Ex: 0263552" autoComplete="off" className="w-full rounded-xl border border-white/10 bg-white/5 py-3 px-4 text-white placeholder-slate-600 focus:outline-none focus:ring-2 focus:ring-amber-400/30 transition-all" />
                </div>
                <div className="space-y-1.5">
